...
# Modify default IP
sed -i 's/192.168.1.1/192.168.82.1/g' package/base-files/files/bin/config_generate
...
sed -i 's|IMG_PREFIX:=|IMG_PREFIX:=CMCC-$(shell TZ="Asia/Shanghai" date +"%Y%m%d")-24.10|' include/image.mk
